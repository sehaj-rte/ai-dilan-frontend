    ...
    const fetchData = async () => {
        try {
            ...
            if (data.success) {
                ...
                try {
                    const legalResp = await fetch(`${API_URL}/publishing/public/expert/${slug}/legal/privacy`);
                    ...
                    if (legalData.success && legalData.content) {
                        ...
                        // Fallback to static
                        const defaultResp = await fetch('/legal/expert/privacy.html');
                        if (defaultResp.ok) {
