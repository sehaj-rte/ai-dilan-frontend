    ...
    const fetchData = async () => {
        try {
            ...
            if (data.success) {
                ...
                try {
                    const legalResp = await fetch(`${API_URL}/publishing/public/expert/${slug}/legal/dpa`);
                    ...
                    if (legalData.success && legalData.content) {
                        ...
                        // Fallback to static
                        const defaultResp = await fetch('/legal/expert/dpa.html');
                        if (defaultResp.ok) {
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="px-8 py-6 border-b border-gray-100 flex items-center justify-between bg-white">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">Data Processing Agreement (DPA)</h1>
